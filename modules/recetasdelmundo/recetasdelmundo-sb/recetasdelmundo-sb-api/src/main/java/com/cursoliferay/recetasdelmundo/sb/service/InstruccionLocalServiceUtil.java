...
/**
 * Provides the local service utility for Instruccion. This utility wraps
 * <code>com.cursoliferay.recetasdelmundo.sb.service.impl.InstruccionLocalServiceImpl</code> and
 ...
 * @generated
 */
public class InstruccionLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.cursoliferay.recetasdelmundo.sb.service.impl.InstruccionLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Instruccion addInstruccion(Instruccion instruccion) {
		return getService().addInstruccion(instruccion);
	}
	 ...
	 */
	public static Instruccion createInstruccion(long instruccionId) {
		return getService().createInstruccion(instruccionId);
	}
	 ...
	 */
	public static Instruccion deleteInstruccion(Instruccion instruccion) {
		return getService().deleteInstruccion(instruccion);
	}
	 ...
	 */
	public static Instruccion deleteInstruccion(long instruccionId)
		throws PortalException {

		return getService().deleteInstruccion(instruccionId);
	}
	...
	public static Instruccion fetchInstruccion(long instruccionId) {
		return getService().fetchInstruccion(instruccionId);
	}
	 ...
	 */
	public static Instruccion fetchInstruccionByUuidAndGroupId(
		String uuid, long groupId) {

		return getService().fetchInstruccionByUuidAndGroupId(uuid, groupId);
	}

	public static List<Instruccion> findByrecetaId(long recetaId) {
		return getService().findByrecetaId(recetaId);
	}
	 ...
	 * @throws PortalException if a instruccion with the primary key could not be found
	 */
	public static Instruccion getInstruccion(long instruccionId)
		throws PortalException {

		return getService().getInstruccion(instruccionId);
	}
	 ...
	 */
	public static Instruccion getInstruccionByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return getService().getInstruccionByUuidAndGroupId(uuid, groupId);
	}
	 ...
	 */
	public static List<Instruccion> getInstruccions(int start, int end) {
		return getService().getInstruccions(start, end);
	}
	 ...
	 */
	public static List<Instruccion> getInstruccionsByUuidAndCompanyId(
		String uuid, long companyId) {

		return getService().getInstruccionsByUuidAndCompanyId(uuid, companyId);
	}
	...
	public static List<Instruccion> getInstruccionsByUuidAndCompanyId(
		...
		return getService().getInstruccionsByUuidAndCompanyId(
	 ...
	 */
	public static int getInstruccionsCount() {
		return getService().getInstruccionsCount();
	}
	 ...
	 */
	public static Instruccion updateInstruccion(Instruccion instruccion) {
		return getService().updateInstruccion(instruccion);
	}

	public static InstruccionLocalService getService() {
		return _service;
	}

	private static volatile InstruccionLocalService _service;

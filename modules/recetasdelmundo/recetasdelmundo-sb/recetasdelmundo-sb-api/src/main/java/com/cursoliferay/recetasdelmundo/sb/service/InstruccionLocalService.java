...
/**
 * Provides the local service interface for Instruccion. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see InstruccionLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface InstruccionLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.cursoliferay.recetasdelmundo.sb.service.impl.InstruccionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the instruccion local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link InstruccionLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Instruccion addInstruccion(Instruccion instruccion);
	...
	public Instruccion createInstruccion(long instruccionId);
	...
	public Instruccion deleteInstruccion(Instruccion instruccion);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Instruccion deleteInstruccion(long instruccionId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Instruccion fetchInstruccion(long instruccionId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Instruccion fetchInstruccionByUuidAndGroupId(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Instruccion getInstruccion(long instruccionId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Instruccion getInstruccionByUuidAndGroupId(String uuid, long groupId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Instruccion> getInstruccions(int start, int end);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Instruccion> getInstruccionsByUuidAndCompanyId(
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Instruccion updateInstruccion(Instruccion instruccion);
